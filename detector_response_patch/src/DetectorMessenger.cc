...
DetectorMessenger::DetectorMessenger(DetectorConstruction* det, Run* run)
  ...
  fPMTResponseModeCmd->SetGuidance("PMT response mode: flat, builtin_curve, builtin_curve_raw, csv_curve, or csv_curve_raw.");
  ...
  fSiPMResponseModeCmd->SetGuidance("SiPM response mode: flat, builtin_curve, builtin_curve_raw, csv_curve, or csv_curve_raw.");
